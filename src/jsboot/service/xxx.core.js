(function() {
  /*global jsBoot:true, Mingus:true, File:true, Blob:true, DOMParser:true, console:true*/
  'use strict';

  (function(Xhr, ake, dig, Err) {

    // /X.Y(?:/name)?(?:/id)?(?:/command)?
    this.Mondane = function(serviceHost, servicePort, serviceVersion, gatePath, keyId, keySecret) {
      // Service data
    ...
    this.Mondane.POST = this.Mondane.prototype.POST = 'POST';
    this.Mondane.GET = this.Mondane.prototype.GET = 'GET';
    this.Mondane.DELETE = this.Mondane.prototype.DELETE = 'DELETE';
    this.Mondane.PUT = this.Mondane.prototype.PUT = 'PUT';

  }).apply(jsBoot.core, [Mingus.xhr.XMLHttpRequest, Mingus.xhr.appKeyEngine,
